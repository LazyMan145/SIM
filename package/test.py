...
class App(CTk.CTk):
    def __init__(self):
        ...
        def data():
            ...
            CheckBox5 = CheckBox1.get()
            CheckBox1 = CheckBox3.get()
            CheckBox3 = CheckBox5.get()
            sstatus = status.get()
        ...
        description1 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="Иванов И И")
        description1.grid(row=13, column=1, columnspan=1, padx=(otstupi, otstupi), pady=(10, 0), sticky="nsew")
        ...
        description2 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="Иванов И И")
        description2.grid(row=14, column=1, columnspan=1, padx=(otstupi, otstupi), pady=(10, 0), sticky="nsew")
        ...
        description3 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="Иванов И И")
        description3.grid(row=15, column=1, columnspan=1, padx=(otstupi, otstupi), pady=(10, 0), sticky="nsew")
        ...
        self.start_time_field_1 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="01.12.2017 10:00:00")
        self.start_time_field_1.grid(row=5, column=3, padx=otstupi, pady=(0, 0), ipadx=otstupi)
        ...
        self.start_plan_field_1 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="02.12.2017 10:00:00")
        self.start_plan_field_1.grid(row=7, column=3, padx=otstupi, pady=(0, 0), ipadx=otstupi)
        ...
        self.end_plan_field_1 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="02.12.2017 22:00:00")
        self.end_plan_field_1.grid(row=8, column=3, padx=otstupi, pady=(0, 0), ipadx=otstupi)
        ...
        self.end_time_work_field_1 = CTk.CTkEntry(self.scrollable_frame_Remedy, placeholder_text="03.12.2017 22:00:00")
        self.end_time_work_field_1.grid(row=10, column=3, padx=otstupi, pady=(0, 0), ipadx=otstupi)
